...
permalink: /doc/zh/lb3/AngularJS-JavaScript-SDK.html
...
If you wish to use Angular 2, the [LoopBack SDK Builder](/doc/zh/community/SDK-builder.html) community project enables you to create an [Angular 2](http://angular.io/) client SDK for a LoopBack application.  
" %}
